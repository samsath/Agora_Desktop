...
urlpatterns = patterns('',
    ...
    url(r'^app/repo/(?P<pname>\w+)/note/upload/(?P<nnote>\w+)/$','Agora_android.views.repoUploadNote'),
    url(r'^app/repo/(?P<pname>\w+)/note/check/(?P<nnote>\w+)/$','Agora_android.views.repoCheckNote'),
